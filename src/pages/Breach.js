...
function Breach() {
  ...
  let navigate = useNavigate();
    ...
    let [videoUrl, setVideoUrl] = useState('https://assets.contentstack.io/v3/assets/bltb6530b271fddd0b1/bltc2d5631f1babcaf0/5ec840e1bab1845d392dfc39/Breach_Q_v001_web.mp4')
    let possesion = '';
    let details = '';
    let qName = '';
    let qDetails = '';
    ...
    let xName = '';
    let xDetails = '';
    const url1 = 'https://assets.contentstack.io/v3/assets/bltb6530b271fddd0b1/bltc2d5631f1babcaf0/5ec840e1bab1845d392dfc39/Breach_Q_v001_web.mp4';
    const url2 = 'https://assets.contentstack.io/v3/assets/bltb6530b271fddd0b1/bltd09eb47222cc1152/5ec840e287617619e2be955e/Breach_E_v001_web.mp4'
    const url3 = 'https://assets.contentstack.io/v3/assets/bltb6530b271fddd0b1/bltfff097ebc7da90e9/5ec840e1e2a559592eb0c0e2/Breach_C_v001_web.mp4'
    const url4 = 'https://assets.contentstack.io/v3/assets/bltb6530b271fddd0b1/blt0a47675f8b973fda/5ec840e252c5395e0f2dd038/Breach_X_v001_web.mp4'
    ...
    if(champions.length > 3) {
      possesion = champions[currentIndex.index].breach[0].possesion;
      
      details = champions[currentIndex.index].breach[0].details;
      qName = champions[currentIndex.index].breach[0].q[0].name;
      qDetails = champions[currentIndex.index].breach[0].q[0].details;
      eName = champions[currentIndex.index].breach[0].e[0].name;
      eDetails = champions[currentIndex.index].breach[0].e[0].details;
      cName = champions[currentIndex.index].breach[0].c[0].name;
      cDetails = champions[currentIndex.index].breach[0].c[0].details;
      xName = champions[currentIndex.index].breach[0].x[0].name;
      xDetails = champions[currentIndex.index].breach[0].x[0].details;
    }
    ...
    <div className='champ-main' draggable={false}>
      <div className='main-bg'>
        ...
        <div className='image-container'>
          <img src="https://images.contentstack.io/v3/assets/bltb6530b271fddd0b1/blt100d13bfa8286a3d/5eb7cdc11ea0c32e33b95fa2/V_AGENTS_587x900_Breach.png" />
        </div>
