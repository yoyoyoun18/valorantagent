...
function Phoenix() {
  ...
  let navigate = useNavigate();
    ...
    let [videoUrl, setVideoUrl] = useState('https://assets.contentstack.io/v3/assets/bltb6530b271fddd0b1/bltad7b0ea9be090042/5ecad82c2f5c7259287654ff/Phoenix_Q_v001_web.mp4')
    let possesion = '';
    let details = '';
    let qName = '';
    let qDetails = '';
    ...
    let xName = '';
    let xDetails = '';
    const url1 = 'https://assets.contentstack.io/v3/assets/bltb6530b271fddd0b1/bltad7b0ea9be090042/5ecad82c2f5c7259287654ff/Phoenix_Q_v001_web.mp4';
    const url2 = 'https://assets.contentstack.io/v3/assets/bltb6530b271fddd0b1/blt318f7ee7d6435fac/5ecad82cf5bd13348a6cac7d/Phoenix_E_v001_web.mp4'
    const url3 = 'https://assets.contentstack.io/v3/assets/bltb6530b271fddd0b1/bltf0ee7c9d84985ecf/5ecad82d957e405e09905751/Phoenix_C_v001_web.mp4'
    const url4 = 'https://assets.contentstack.io/v3/assets/bltb6530b271fddd0b1/blt50beaed6524c3219/5ecad82bc846021917ecbb89/Phoenix_X_v001_web.mp4'
    ...
    if(champions.length > 3) {
      possesion = champions[currentIndex.index].phoenix[0].possesion;
      
      details = champions[currentIndex.index].phoenix[0].details;
      qName = champions[currentIndex.index].phoenix[0].q[0].name;
      qDetails = champions[currentIndex.index].phoenix[0].q[0].details;
      eName = champions[currentIndex.index].phoenix[0].e[0].name;
      eDetails = champions[currentIndex.index].phoenix[0].e[0].details;
      cName = champions[currentIndex.index].phoenix[0].c[0].name;
      cDetails = champions[currentIndex.index].phoenix[0].c[0].details;
      xName = champions[currentIndex.index].phoenix[0].x[0].name;
      xDetails = champions[currentIndex.index].phoenix[0].x[0].details;
    }
